    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          currency: optStr("ARS | USD | EUR (opcional; default moneda del hogar)"),
          category_key: optStr("Clave de categoría (opcional; default other)"),
          occurred_at: optStr("YYYY-MM-DD (opcional; default hoy)"),
          payment_method_id: optStr("ID método de pago (opcional; default efectivo)"),
